...
{
    /// <inheritdoc />
    public partial class add_tbl_payment_info : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VnpBankTranNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VnpCardType = table.Column<string>(type: "nvarchar(max)", nullable: true),
