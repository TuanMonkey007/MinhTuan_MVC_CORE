...
namespace MinhTuan.Domain.Migrations
{
    ...
    [Migration("20240630150657_al_tbl_product_add_IsDisplay")]
    partial class al_tbl_product_add_IsDisplay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinhTuan.Domain.Entities.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MinhTuan.Domain.Entities.Article_Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MinhTuan.Domain.Entities.PaymentInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MinhTuan.Domain.Entities.Article_Category", b =>
                {
                    b.HasOne("MinhTuan.Domain.Entities.Article", "Article")
                        .WithMany()
