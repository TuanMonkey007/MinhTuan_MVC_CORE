<template>
  <a-layout style="min-height: 100vh">
    <a-drawer v-model:visible="visible" class="custom-class" style="color: red"   :closable="false"  placement="left" :width="250">
     <template #title>
      ...
      <a-menu v-model:selectedKeys="selectedMenu" mode="inline" style="border: none;padding-top: 10px;font-size: 16px;font-weight: 500">
        ...
        <a-sub-menu key="Settings">
          ...
          <a-menu-item v-if="isAdmin" key="Account"><router-link :to="{ name: 'AccountHome' }">Tài khoản
              người
              dùng</router-link></a-menu-item>
          <a-menu-item key="Category"><router-link :to="{ name: 'CategoryHome' }">Danh mục dùng
              chung</router-link></a-menu-item>
        </a-sub-menu>
      </a-menu>
    </a-drawer>
    <a-layout-header style="background-color: #fff; position: fixed; z-index: 1;width: 100%;margin-bottom: 64px;  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05), 0 4px 16px rgba(0, 0, 0, 0.1);">
...
.close-icon:hover {
  animation: spin 1s linear infinite; /* Chỉ áp dụng animation khi hover */
}
