<template lang="">
  <a-layout style="min-height: 100vh" >
    <a-layout-sider v-model:collapsed="collapsed" theme="dark" collapsible :width="250" :trigger="null">
...
<a-menu-item key="Account"><router-link :to="{ name: 'AccountHome' }">Tài khoản người dùng</router-link></a-menu-item>
<a-menu-item key="Category"><router-link :to="{ name: 'CategoryHome' }">Danh mục dùng chung</router-link></a-menu-item>
</a-sub-menu>
</a-menu>
</a-layout-sider>
<a-layout>
  <a-layout-header style="
        ...
        ">
    <div>
      <menu-unfold-outlined :style="{ fontSize: '24px' }" v-if="collapsed" class="trigger"
        @click="() => (collapsed = !collapsed)" />
      <menu-fold-outlined :style="{ fontSize: '24px' }" v-else class="trigger"
        @click="() => (collapsed = !collapsed)" />
    </div>
    <!-- Profile -->
    <div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      updateSelectedMenu(newKeys) { // Đổi tên phương thức thành updateSelectedMenu
