<template>
    <div>
        <a-modal v-model:open="open" title="Chi tiết tài khoản" :footer="null" width="700px" style="top: 20px;">
            <a-form ref="formRef" :model="account" layout="vertical"  >
                <a-row :gutter="30">
                    <a-col :span="12">

                        <a-form-item label="Avatar" name="avatar" >
                            <a-upload list-type="picture-card" :showUploadList="true" accept=".jpg,.jpeg,.png" disabled="true"
                    ...
                    <a-col :span="12">
                        <a-form-item label="Giới tính" name="gender">
                            <a-radio-group v-model:value="account.gender" disabled="true">
                        ...
                        <a-form-item label="Ngày sinh" name="birthDay" :rules="[{ validator: validateBirthDay }]">
                            <a-date-picker v-model:value="account.birthDay" format="YYYY-MM-DD"
                                placeholder="Chọn ngày sinh" disabled="true" />
                ...
                <a-row :gutter="30">
                    <a-col :span="12">
                        <a-form-item label="Họ và tên" name="fullName"
                            ...
                            <a-input disabled="true" type="text" v-model:value="account.fullName" />
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item label="Xác thực" name="EmailConfirmed">
                           
                            <a-switch disabled="true" v-model:checked="checkEmailConfirmed" :loading="isLoading" @change="handleChangeEmailcomfirmed">
                ...
                <a-row :gutter="30">
                    <a-col :span="12">
                        <a-form-item label="Email" name="email"
                            ...
                            <a-input type="email" disabled="true" v-model:value="account.email" />
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item label="Số điện thoại" name="phoneNumber"
                            ...
                            <a-input disabled="true" v-model:value="account.phoneNumber" />
                        </a-form-item>
                    </a-col>
                </a-row>
                ...
                <a-row>
                    <a-col :span="24">
                        <a-form-item label="Địa chỉ" name="address">
                            <a-textarea disabled="true" v-model:value="account.address" />
                        </a-form-item>
                    </a-col>
                ...
                <a-row>
                    ...
                    <a-col :span="4">
                        <a-form-item>
                            <a-switch disabled="true" v-model:checked="checkLockOut" :loading="isLoading" @change="handleChangeLockOut">
