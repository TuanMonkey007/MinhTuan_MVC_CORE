<template>
    ...
    <a-card class="container" style="display: grid; align-items: center; justify-content: center;">
        <a-tabs v-model:activeKey="activeKey" centered size="large" style="background: white;
    width: fit-content;
    ...
    box-shadow: rgba(150, 150, 150, 0.5) 0px 1px 20px 20px;">
                ...
                <a-row>
                    <a-col :span="24">
                        <a-form :model="formLogin" name="normal_login" class="login-form" @finish="onFinish"
                            ...
                            <a-form-item label="SĐT/Email" name="phoneOrEmail"
            ...
            <a-tab-pane key="RegisterTab">
                ...
                <a-row>
                    <a-col :span="24">
                        <a-form :model="formRegis" name="normal_login" class="login-form" @finish="onFinishRegister"
                            v-bind="layout" @finishFailed="onFinishFailed">
                            ...
                            <a-button :loading="loading" :disabled="disableBtnRegis" type="primary" html-type="submit"
                                class="login-form-button">
                                Đăng ký
                            </a-button>
            ...
            <a-tab-pane key="ForgotTab" force-render>
                ...
                <a-row>
                    <a-col :span="24">
                        <a-form :model="formForgot" name="normal_login" class="login-form" @finish="onFinishForgot"
                            @finishFailed="onFinishFailed">
                            <a-form-item label="Email" name="Email"
                                :rules="[{ required: true, message: 'Vui lòng nhập email!' }, { type: 'email', message: 'Email không hợp lệ!' }]">
...
<script>
    ...
    import {
        HomeOutlined, UserAddOutlined, UserOutlined, LockOutlined,
        PhoneOutlined,
        MailOutlined,
        FacebookOutlined,
        GoogleOutlined
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const disableBtnRegis = computed(() => {
                return !formRegis.FullName || !formRegis.PhoneNumber || !formRegis.Email || !formRegis.Password || !formRegis.ConfirmPassword;
            });
