              ...
              <a-checkbox-group v-model:value="selectedRoles">
                <a-row>
                  ...
                  <a-col :span="24" style="margin-top: 10px">
                    <a-textarea v-model:value="reasonTextAria" show-count :maxlength="200" />
                  </a-col>
    ...
    methods: {
      async showModal(id) {
        const responseRole = await APIService.get(
          "datacategory/get-list-by-parent-code/LY_DO_HUY_KH"
        );
      ...
      async handleSubmitAsync() {
        ...
        try {
          ...
          const response = await APIService.put(
            ...
            {
                reasonCancel : this.selectedRoles.join(', ') + ' - ' + this.reasonTextAria
            }
          );
