<template>
                ...
                <template #title>
                    <a-breadcrumb separator=">" style="margin-left:30px;">
                        ...
                        <a-breadcrumb-item class="active">
                            ...
                            <span style="color: #fff;"> Chính sách giao hàng, hận hàng và kiểm hàng</span>
                        </a-breadcrumb-item>
    ...
    <a-row justify="center">
        ...
        <a-col :xs="22" :sm="22" :md="14" :lg="14" :xl="14">
            <h2 style="display: flex; justify-content: center; justify-self: center">CHÍNH SÁCH GIAO HÀNG, NHẬN HÀNG VÀ KIỂM HÀNG</h2>
